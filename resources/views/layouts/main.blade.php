...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="#" class="d-lg-none">
                            <img alt="Logo" src="{{ asset($service['data_konfig']->logo) }}" class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                            ...
                            <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ route('profil.edit', auth()->user()->id) }}" class="menu-link px-5">
                                            Profil Saya</a>
                                    </div>
                                    <!--end::Menu item-->
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="265px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        <!--begin::Logo image-->
                        <a href="#">
                            <img alt="Logo" src="{{ asset($service['data_konfig']->logo) }}" class="h-25px" style="margin-right:8px;" />
                            <strong class="text-light app-sidebar-logo-default">{{ $service['data_konfig']->nama_sistem }}</strong>
                        </a>
                        <!--end::Logo image-->
                    ...
                    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="0px" data-kt-scroll-save-state="true">
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                <a href="{{ route('dashboard.index') }}" class="menu-item here @if($title == 'Dashboard') show @endif menu-accordion">
                                ...
                                <!-- <div class="menu-item pt-5">
                                    <div class="menu-content">
                                        <span class="menu-heading fw-bold text-uppercase fs-7">Fitur</span>
                                    </div>
                                </div> -->
                                <!--end:Menu item-->
                                <!--begin:Menu item-->
                                <!-- <a href="{{ route('pengajuan_uji.index') }}" class="menu-item @if($title == 'Pengajuan') show @endif menu-accordion">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="menu-title">Pengajuan Uji Produk</span>
                                    </span>
                                </a> -->
                                <!--end:Menu item-->

                                <!--begin:Menu item-->
                                <!-- <a href="{{ route('status_pengujian.index') }}" class="menu-item @if($title == 'Status Pengujian') show @endif menu-accordion">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="menu-title">Status Pengujian</span>
                                    </span>
                                </a> -->
                                ...
                                <!-- <a href="{{ route('kelola_banner.index') }}" class="menu-item @if($title == 'Kelola Banner') show @endif menu-accordion">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <!--begin:Menu item-->
                                <a href="{{ route('kelola_jenis_pengujian.index') }}" class="menu-item @if($title == 'Data Jenis Pengujian') show @endif menu-accordion">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="menu-title">Data Jenis Pengujian</span>
                                    </span>
                                </a>
                                <!--end:Menu item-->

                                <!--begin:Menu item-->
                                <a href="{{ route('kelola_parameter_uji.index') }}" class="menu-item @if($title == 'Data Parameter Uji') show @endif menu-accordion">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                        ...
                                        <span class="menu-title">Data Parameter Uji</span>
                                    </span>
                                    <!--end:Menu link-->
                                </a>
                                <!--end:Menu item-->
                                ...
                                <!-- <a href="{{ route('kelola_jenis_status.index') }}" class="menu-item @if($title == 'Kelola Jenis Status') show @endif menu-accordion">
                                    <span class="menu-link">
                                        ...
                                        <span class="menu-title">Kelola Jenis Status</span>
                                    </span>
                                </a> -->
                                <!--end:Menu item-->
                                ...
                                <!--begin:Menu item-->
                                <a href="{{ route('kelola_pengguna.index') }}" class="menu-item @if($title == 'Data Pelanggan') show @endif menu-accordion">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
                            ...
                            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                ...
                                <!--end:Menu item-->
                                <!--begin:Menu item-->
                                <a href="{{ route('pengajuan.index') }}" class="menu-item @if($title == 'Pengajuan') show @endif menu-accordion">
                                    <!--begin:Menu link-->
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
                                ...
                                <!--begin:Menu item-->
                                <!-- <a href="{{ route('status_uji.index') }}" class="menu-item @if($title == 'Status Uji') show @endif menu-accordion">
                                    <span class="menu-link">
                                        <span class="menu-icon">
                                            <span class="svg-icon svg-icon-2">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- <script src="{{ asset('tema') }}/dist/assets/plugins/custom/datatables/datatables.bundle.js"></script> -->
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('tema') }}/dist/assets/js/widgets.bundle.js"></script>
    <script src="{{ asset('tema') }}/dist/assets/js/custom/widgets.js"></script>
    <script src="{{ asset('tema') }}/dist/assets/js/custom/apps/chat/chat.js"></script>
    <script src="{{ asset('tema') }}/dist/assets/js/custom/utilities/modals/upgrade-plan.js"></script>
    <script src="{{ asset('tema') }}/dist/assets/js/custom/utilities/modals/create-app.js"></script>
    <script src="{{ asset('tema') }}/dist/assets/js/custom/utilities/modals/new-target.js"></script>
    <script src="{{ asset('tema') }}/dist/assets/js/custom/utilities/modals/users-search.js"></script>
    <!--end::Custom Javascript-->
    <!--end::Javascript-->

    <!--begin::Global Javascript Data Table-->
