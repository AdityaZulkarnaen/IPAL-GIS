<div class="bg-white border border-slate-200 rounded-xl shadow-panel mb-8" id="pipe-table-card">
    ...
    <div class="px-6 pb-6 pt-0">
        <div class="flex flex-wrap items-center gap-2.5 mb-5">
            <input id="pipe-search" type="text" class="h-10 w-full md:w-[250px] rounded-lg border border-slate-300 bg-white px-3 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-200" placeholder="Cari ID pipa, jalur, fungsi, wilayah">
            ...
            <select id="pipe-wilayah" class="h-10 w-full md:w-[225px] rounded-lg border border-slate-300 bg-white px-3 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-200">
        ...
        <div class="overflow-x-auto rounded-lg border border-slate-200">
            <table class="min-w-full border-collapse bg-white">
                ...
                <tbody id="pipe-tbody">
                    <tr>
                        <td colspan="7" class="py-8 text-center text-sm text-slate-500">Memuat data pipa...</td>
                    </tr>
                </tbody>
            </table>
        </div>
