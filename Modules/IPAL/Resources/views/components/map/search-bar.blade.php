<div id="search-bar-container" class="fixed bottom-14 left-1/2 -translate-x-1/2 z-[500] w-[520px] max-w-[calc(100vw-2rem)]">
    ...
    {{-- Search bar card --}}
    <div class="bg-white rounded-2xl shadow-lg px-4 py-2.5 flex items-center gap-2.5">
        ...
        <button id="search-btn"
                class="hidden md:block text-[13px] font-semibold text-white bg-[#13C8EC] border-none rounded-lg px-4 py-1.5 cursor-pointer transition-colors shrink-0">
            Cari Data
        </button>
    </div>
</div>
