<div id="legend-panel" class="fixed bottom-28 left-4 md:left-auto md:bottom-auto md:top-[72px] md:right-4 z-[500] bg-white rounded-2xl shadow-lg p-4 w-40 max-w-[calc(100vw-2rem)]">
