<div class="fixed bottom-6 left-1/2 -translate-x-1/2 z-[500] bg-white rounded-2xl shadow-lg px-4 py-2.5 flex items-center gap-2.5 w-[520px] max-w-[calc(100vw-2rem)]">
