...
<div id="kt_app_content" class="app-content flex-column-fluid pt-3 sm:pt-4 bg-white">
    <div id="kt_app_content_container" class="app-container container-fluid max-w-[1280px]">
        <div class="mb-4 sm:mb-6 flex flex-col w-full gap-4">
            <div>
            ...
            <div class="flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="rounded-[14px] border border-[#e4e8f1] bg-[#f7f8fc] p-1 hidden sm:flex w-full sm:max-w-[360px]">
                    <button
                ...
                <div class="flex flex-row items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                    <a
