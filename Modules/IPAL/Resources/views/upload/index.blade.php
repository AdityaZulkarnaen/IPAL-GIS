        ...
        <div class="mb-4 sm:mb-6 flex flex-col sm:flex-row items-start w-full sm:items-end justify-between gap-4">
            ...
            <div class="flex flex-row items-center justify-between sm:justify-center gap-3 w-full sm:w-auto">
                <a
                    ...
                    class="h-fit w-[50%] sm:w-auto py-3 px-2 rounded-[8px] border border-[#e5e7ef] bg-[#f5f6fa] text-[#5f6b84] font-semibold text-[12px] inline-flex items-center justify-center gap-2 hover:bg-[#eef1f8]"
                >
                ...
                <button
                    ...
                    type="button"
                    class="h-fit w-[50%] sm:w-auto py-3 px-4 rounded-[8px] border border-[#1b84ff] bg-[#1b84ff] text-white font-semibold text-[12px] inline-flex items-center justify-center gap-2 hover:bg-[#1576e8]"
                >
                    ...
                    <span id="upload-button-label">Upload Jaringan Pipa</span>
                </button>
            </div>
        </div>
